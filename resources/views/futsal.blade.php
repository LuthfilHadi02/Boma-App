...
<body class="bg-slate-50 text-slate-800 antialiased font-['Inter']">
    ...
    <section class="futsal-hero min-h-[60vh] flex items-center relative overflow-hidden">
        <div class="container hero-content-basket relative z-10">
            ...
            <h1 class="text-4xl md:text-6xl font-['Montserrat'] font-900 tracking-tight text-white mb-4">FUTSAL</h1>
            <p class="text-lg text-white/90 max-w-xl mb-6 leading-relaxed">Mengasah kelincahan, taktik cepat, dan kekompakan tim di atas lapangan. Kami bermain dengan kebanggaan dan sportivitas.</p>
        ...
        <section class="section-padding">
            <div class="about-basket-grid grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="about-text space-y-6">
                    <h2 class="text-3xl font-['Montserrat'] font-bold text-slate-900">Sejarah & Visi Divisi Futsal</h2>
                    <p class="text-slate-600 leading-relaxed text-justify">Bidang Futsal BOMA menjadi salah satu divisi dengan peminat tertinggi. Kami berdedikasi untuk mencetak talenta-talenta berbakat yang siap bertarung di berbagai liga kampus dan kejuaraan nasional, dengan menjunjung tinggi nilai persaudaraan.</p>
                    ...
                    <div class="stats-row grid grid-cols-3 gap-4 pt-4">
                        <div class="stat-box p-4 bg-white rounded-2xl shadow-sm border border-slate-100 text-center transition-all hover:shadow-md">
                            <h3 class="text-3xl font-['Montserrat'] font-extrabold text-orange-600">20+</h3>
                            <span class="text-xs text-slate-500 font-medium block mt-1">Trofi Liga</span>
                        </div>
                        <div class="stat-box p-4 bg-white rounded-2xl shadow-sm border border-slate-100 text-center transition-all hover:shadow-md">
                            <h3 class="text-3xl font-['Montserrat'] font-extrabold text-emerald-600">65</h3>
                            <span class="text-xs text-slate-500 font-medium block mt-1">Anggota Aktif</span>
                        </div>
                        <div class="stat-box p-4 bg-white rounded-2xl shadow-sm border border-slate-100 text-center transition-all hover:shadow-md">
                            <h3 class="text-3xl font-['Montserrat'] font-extrabold text-blue-600">3</h3>
                            <span class="text-xs text-slate-500 font-medium block mt-1">Pelatih Berlisensi</span>
                        </div>
                    </div>
                </div>
                <div class="about-img overflow-hidden rounded-2xl shadow-xl border border-slate-100 transform hover:scale-[1.01] transition-all duration-300">
                    <img src="https://images.unsplash.com/photo-1511886929837-354d827aae26?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Tim Futsal BOMA" class="w-full h-auto object-cover">
                </div>
            </div>
        </section>
        ...
        <section class="section-padding">
            <div class="schedule-banner bg-gradient-to-br from-emerald-900 to-slate-950 text-white rounded-3xl p-8 md:p-12 text-center shadow-xl relative overflow-hidden space-y-6">
                <div class="relative z-10 space-y-3">
                    ...
                    <p class="text-slate-300 max-w-lg mx-auto text-sm md:text-base">Latihan rutin diadakan di Lapangan Futsal Utama. Ayo asah skill kamu!</p>
                </div>
                <div class="jadwal-badges flex flex-wrap justify-center gap-3 relative z-10">
                    <span class="badge-waktu bg-white/10 px-4 py-2 rounded-xl text-xs font-medium border border-white/10 flex items-center gap-2"><i class="fa-regular fa-calendar text-orange-400"></i> Senin & Rabu</span>
                    <span class="badge-waktu bg-white/10 px-4 py-2 rounded-xl text-xs font-medium border border-white/10 flex items-center gap-2"><i class="fa-regular fa-clock text-orange-400"></i> 19.00 - 21.00 WIB</span>
                </div>
                <div class="relative z-10 pt-2">
                    <button class="btn-futsal-join bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold px-8 py-3.5 rounded-xl shadow-lg transition-all transform hover:-translate-y-0.5">Daftar Anggota Baru</button>
                </div>
            </div>
        </section>
