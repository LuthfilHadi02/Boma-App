                    ...
                    <div class="card-body p-4">
                        ...
                        @if($pendingMitraRequests > 0)
                            <a href="{{ route('admin.mitra.index', ['status' => 'Pending_Verification']) }}" class="d-flex align-items-center p-3 border-bottom text-decoration-none text-dark">
                                ...
                                <div>
                                    <strong class="d-block">{{ $pendingMitraRequests }} Mitra Menunggu Verifikasi</strong>
                                    <small class="text-muted">Perlu tindakan verifikasi sertifikasi lapangan baru, pak.</small>
                                </div>
                            </a>
                        @endif
                        ...
                        @if($pendingRefunds > 0)
                            <a href="{{ route('admin.payments.index') }}" class="d-flex align-items-center p-3 border-bottom text-decoration-none text-dark">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Data sengketa ini memerlukan tindakan persetujuan segera.</small>
                                </div>
                            </a>
                        @endif

                        @if($pendingMitraRequests == 0 && $pendingRefunds == 0)
                            <div class="p-4 text-center text-muted">
                                <i class="fa-solid fa-check-circle text-success mb-2 fs-3"></i>
                                <p class="mb-0">Tidak ada tindakan mendesak yang memerlukan perhatian Admin.</p>
                            </div>
                        @endif
                    </div>
                </div>
